...
export class Migration20230325154420 extends Migration {
  async up(): Promise<void> {
    this.addSql('alter table "option" alter column "text" type varchar(255) using ("text"::varchar(255));');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "option" alter column "text" type varchar using ("text"::varchar);');
  }
}
